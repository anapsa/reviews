...
const { createUser, getUsers, findUser, findUserByEmail, followUser, deleteUser, updateUser, addWatched,addAbandoned, getWatched,getAbandoned,deleteWatched,deleteAbandoned, findWatchedInfo} = require("../controllers/userController");
