...
Scenario: Criar uma review não estando logado
    Given que o usuário "ana@email.com" não está autenticado no sistema
...
Scenario: Deletar uma review
    Given que o usuário "ana@email.com" está autenticado no sistema 
    And o usuário "ana@email.com" é proprietário da review com título "Título da Review", corpo "Conteúdo da Review" e classificação 5
...
Scenario: Editar uma review
    Given que o usuário "ana@email.com" está autenticado no sistema 
    And o usuário "ana@email.com" é proprietário da review com título "Título da Review", corpo "Conteúdo da Review" e classificação 5
    When uma requisição PUT com um JSON com corpo "Mudei minha review" para a rota "http://localhost:5001/reviews/edit"
