...
Given que um usuário cadastrado com username "QuinhasAb" quer criar uma lista de assistidos
...
Given que um usuário cadastrado com username "QuinhasAb" quer cadastrar um filme na lista de assistidos
...
Then o status da resposta de adição deve ser "200"
...
Given que um usuário cadastrado com username "QuinhasAb" quer cadastrar novamente na lista de assistidos
...
Given que um usuário cadastrado com username "QuinhasAb" quer obter informações de um filme da lista de assistidos
...
Given que um usuário cadastrado com username "QuinhasAb" quer obter todas informações da lista de assistidos
...
Given que um usuário cadastrado com username "QuinhasAb" quer atualizar um filme da lista de assistidos
...
Given que um usuário cadastrado com username "QuinhasAb" quer deletar um filme da lista de assistidos
...
Given que um usuário cadastrado com username "QuinhasAb" quer ver informações de um filme da lista de assistidos
...
Given que um usuário cadastrado com username "QuinhasAb" deseja deletar um filme da lista de assistidos
